...
################################################################################
#  Helper functions for list.sort
# ------------------------------------------------------------------------------
def sortSecond(val):
    return val[2]
...
#Adds all possible moves for a given white rook to the child list
...
#Adds all possible moves for a given white bishop to the child list
...
#Adds all possible moves for a given white king to the child list
...
#Adds all possible moves for a given black knight to the child list
...
#Adds all possible moves for a given black rook to the child list
...
#Adds all possible moves for a given black bishop to the child list
...
#Adds all possible moves for a given black king to the child list
...
# Output optimal a-b search result and additional details
